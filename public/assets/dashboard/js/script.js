...
$('#profile_form_profession').change(function () {
    ...
    $.ajax({
        ...
        success: function (experiences) {
            var experienceSelect = $("#profile_form_experience");
...
function initAutocomplete() {
    ...
    autocomplete = new google.maps.places.Autocomplete(
      /** @type {!HTMLInputElement} */(document.getElementById('address_form_fullAddress')),
        { types: ['geocode'] });
...
function fillInAddress() {
    ...
    for (var i = 0; i < place.address_components.length; i++) {
        ...
        if (place.address_components[i].types[0] == 'street_number') {
            var addressType = 'registration_step_two_form_route';
        }
