...
$(document).ready(function () {
    ...
    $('input[name="registration_step_two_form[thumbnail]"]').fileuploader({
        limit: 20,
        maxSize: 50,
    ...
    $('input[name="registration_step_two_form[avatar__]"]').fileuploader({
        limit: 2,
        ...
        upload: {
            url: Routing.generate('upload_avatar_register', { token: token }),
            data: null,
            type: 'POST',
