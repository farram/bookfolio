...
import tileFullLightImagesHome from '../components/portfolio/tileFullLightImagesHome.vue';
...
vueInit("tileFullLightImagesHome", {
    vuetify: new Vuetify(),
    GoTop,
    VueMasonry,
    VueResource,
    VueImg,
    render: h => h(tileFullLightImagesHome)
})

import tileFullLightImagesGallery from '../components/portfolio/tileFullLightImagesGallery.vue';
vueInit("tileFullLightImagesGallery", {
    vuetify: new Vuetify(),
    GoTop,
    VueMasonry,
    VueResource,
    VueImg,
    render: h => h(tileFullLightImagesGallery)
})
