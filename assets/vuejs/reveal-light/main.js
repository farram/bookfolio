...
import wideDarkImagesHome from '../components/reveal-light/imagesHome.vue';
import wideDarkImagesGallery from '../components/reveal-light/ImagesGallery.vue';
...
vueInit("items_gallery", {
    ...
    VueResource,
    VueImg,
    render: h => h(wideDarkImagesGallery)
})
